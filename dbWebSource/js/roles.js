...
function manageItem(id,name){
    ...
    $(".modal-title").text("Roles Menu for » " + name);
...
function displayRecords(){   
    ...
    $("#grid").dataBind({
        ...
        ,dataRows       :[
    		...
    		,{ text:"Role Name"     , width:98  , style:"text-align:center;" ,type:"input"  ,name:"role_name"}	 
    		,{ text:"Export Excel?" , width:110 , style:"text-align:center;" ,type:"yesno"  ,name:"is_export_excel"  ,defaultValue:"Y"}	 
    		...
    		,{ text:"Role Menus"    , width:80 , style:"text-align:center;"  
...
function displayRRolesMenu(id){   
    ...
    $("#" + tblName).dataBind({
         url   : procURL + "role_menus_sel @role_id=" + id 
        ,width          : 560
	    ,height         : 400
        ...
        ,dataRows       :[
    		...
    		,{ text:"Menu Name"     , width:200 , style:"text-align:center;"  ,name:"menu_name"  }	 
...
function displayUsers(id){   
    $("#" + tblNameUser).dataBind({
	    ...
	    ,height         : 400
        ,dataRows       :[
    		 { text: "User Name"     , width:250  , style:"text-align:left, margin-left;" ,name:"user_name" }
        ]
    });    
}
